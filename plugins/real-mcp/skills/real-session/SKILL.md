---
name: real-session
description: Validate REAL MCP session by listing tools and calling workspace_summary. Use when verifying authentication, after OAuth, or when other REAL skills fail with 401/403/429.
---
