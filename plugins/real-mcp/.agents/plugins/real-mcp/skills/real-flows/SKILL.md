---
name: real-flows
description: Inspect and propose enable/start for REAL multi-step DM journeys (flows_list, flow_get, flow_sessions_list, flow_set_enabled, flow_start).
---

# Skill: real-flows

**Prerequisite:** `real-universal-workflow` + `references/write-lifecycle.md` for writes.
