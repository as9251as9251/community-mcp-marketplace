...
description: Search REAL inbox message bodies with messages_search (read-only, max 30-day window). Use for keyword investigation before drafting replies or FAQ.
---
...
5. If the user wants a reply, hand off to `real-messaging` (preview-gate) — do not send from this skill.
