---
name: real-reservations
description: List and propose updates to REAL reservations (reservations_list, reservation_update_status, reservation_reschedule).
---

# Skill: real-reservations
