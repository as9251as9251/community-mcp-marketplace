---
name: s1mple-ops
description: s1mple project ops via MCP — summary, reservations, dispatch, knowledge search, memory, and human-approved write proposals.
---
...
- Stay on `s1mple` / `s1mple-pro.com` only.
