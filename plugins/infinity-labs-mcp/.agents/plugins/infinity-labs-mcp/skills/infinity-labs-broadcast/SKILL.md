---
name: infinity-labs-broadcast
description: List broadcasts, preview audience size, and propose draft broadcasts on INFINITY LABS (broadcast_list, broadcast_audience_preview, broadcast_create).
---

# Skill: infinity-labs-broadcast

**Prerequisite:** `infinity-labs-universal-workflow` + `references/write-lifecycle.md` for create.
