---
name: infinity-labs-reservations
description: List and propose updates to INFINITY LABS reservations (reservations_list, reservation_update_status, reservation_reschedule).
---

# Skill: infinity-labs-reservations
