...
**以我們的商家場景與已上線 MCP 為準；Skill 不描述沒有工具的能力。**

| 要做 | 不要做 |
|---|---|
| 薄外殼：市集只放 MCP URL＋Skill＋Command | 預寫沒有實作的群發／旅程／調查流程 |
...
**一句話：**  
我們賣的是「多品牌商家、授權綁專案、先讀後提議、核准才生效」的 Agent 行為；公開包只負責連到對的站、用對的工具。
